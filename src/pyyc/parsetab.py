...
_lr_productions = [
  ...
  ('expr_list -> expression COMMA expr_list','expr_list',3,'p_append_to_list','parse.py',276),
  ('key_datum_list -> key_datum','key_datum_list',1,'p_keydatum_list','parse.py',284),
  ('key_datum_list -> key_datum COMMA key_datum_list','key_datum_list',3,'p_keydatum_list_appendto_list','parse.py',288),
  ('target -> subscription','target',1,'p_target_subscription','parse.py',301),
  ('statement -> target ASSIGN expression','statement',3,'p_target_statement','parse.py',306),
]
